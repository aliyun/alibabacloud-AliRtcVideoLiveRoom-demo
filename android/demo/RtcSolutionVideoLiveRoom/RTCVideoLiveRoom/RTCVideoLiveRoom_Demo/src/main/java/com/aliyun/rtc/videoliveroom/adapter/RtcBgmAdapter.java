...
public class RtcBgmAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.rtc_videoliveroom_item_bgm, parent, false);
    ...
    private int getPreplayResId(int prePlayState) {
        return prePlayState == RtcAudioFileInfo.PLAYING || prePlayState == RtcAudioFileInfo.RESUME ? R.drawable.rtc_videoliveroom_pause_icon : R.drawable.rtc_videoliveroom_preplay_icon;
    }

    private int getPlayResId(int playState) {
        return playState == RtcAudioFileInfo.PLAYING || playState == RtcAudioFileInfo.RESUME ? R.drawable.rtc_videoliveroom_pause_icon : R.drawable.rtc_videoliveroom_play_icon;
    }
